...
def class_result():
    ...
    print('{0:<8}{1:<20}{2:<10}{3:<10}{4:<10}{5:<10}{6:<10}'.format('Rollno', 'Name', 'English', 'Maths', 'Physics',
                                                                    'Chemistry', 'CS'))
...
def intro():
    ...
    print("{: ^80s}".format("Project in Python"))
    print("{: ^80s}".format("Made By: Engr. Md. Mosarraf Hossen"))
    print("@" * 80)
    print()
